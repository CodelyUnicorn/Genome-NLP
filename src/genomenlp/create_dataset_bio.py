...
def main():
    ...
    infile_path_1 = "data1/non_promoter.fasta.gz"
    infile_path_2 = "data1/promoter.fasta.gz"
    tokeniser_path = "data1/tokens.json"
    outfile_dir = "data1/"
    ...
    tmp_infile = "".join([outfile_dir, "/.data1.tmp"])
    ...
    tmp_hf_out = "".join([outfile_dir, "data1.hf.csv"])
