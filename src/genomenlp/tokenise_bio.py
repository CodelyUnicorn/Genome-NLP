...
def main():
    ...
    infile_paths= ['out_segment/NC_000022.11_1.fasta', 'out_segment/NC_000022.11_2.fasta']
    tokeniser_path = 'REDATA/tokens.json'
    vocab_size = args.vocab_size
    break_size = args.break_size
    case = args.case
    special_tokens = args.special_tokens
